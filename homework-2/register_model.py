...
HPO_EXPERIMENT_NAME = "random-forest-hyperoptm"
...
def run(data_path, log_top):
    ...
    best_run_runid = best_run.info.run_id
    best_run_uri = f"runs:/{best_run_runid}/model"
    mlflow.register_model(model_uri=best_run_uri, name="nyc-taxi-regressor")
